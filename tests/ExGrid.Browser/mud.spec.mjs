...
// this is the real one. Plus the hover band (UX-12, ADR-0021's fifth entry) and the
...
test('the row under the pointer is highlighted by an overlay band, in the hovered instance only (UX-12)', async ({ page }) => {
    await open(page);
