...
| 0043 | **Pinning is suspended** while the Pinned block would leave the scrollable columns under 40px; the View State's count stands, and reorder and the pin commands keep reading it | `ColumnGeometryTests`, `PinnedColumnTests`, `sizing.spec.mjs` |
