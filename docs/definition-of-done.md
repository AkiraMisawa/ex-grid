...
| **KB-35** | MUST | An Escape pressed straight after an Inner Popup opens closes that popup and leaves the popover standing (ADR-0039) | Layer 3 on the Server host with a 150 ms round trip, under the mud Chrome | the popup is gone, the panel stands with the keyboard |
