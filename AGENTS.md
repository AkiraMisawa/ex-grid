...
| `docs/adr/` | **Decisions and their reasons.** 39 of them. The implementation follows these |
...
The principles that run through all 39 ADRs. **A new decision that follows these will not
