...
| `docs/adr/` | **Decisions and their reasons.** 43 of them. The implementation follows these |
...
The principles that run through all 43 ADRs. **A new decision that follows these will not
