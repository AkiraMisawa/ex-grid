...
| `docs/adr/` | **Decisions and their reasons.** 37 of them. The implementation follows these |
...
The principles that run through all 37 ADRs. **A new decision that follows these will not
